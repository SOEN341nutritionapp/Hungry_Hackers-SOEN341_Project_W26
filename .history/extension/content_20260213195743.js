...
function extractNameFromRow(row) {
  ...
  // Otherwise: choose best text chunk that is NOT price and looks like product name
  ...
  // Choose the longest “good” candidate (product names usually longer than labels)
