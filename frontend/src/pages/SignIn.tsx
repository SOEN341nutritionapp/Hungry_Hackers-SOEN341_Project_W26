      ...
      <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-8 md:px-16">
        <div className="max-w-md mx-auto w-full">
          ...
          <p className="text-slate-600 text-sm mb-8 font-normal">
            Log in to manage your weekly meal plan.
          </p>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                <input 
                  ...
                  className="w-4 h-4 rounded border border-gray-300 text-green-500 focus:ring-green-500"
                />
                <span className="text-slate-600 text-sm font-normal">Remember me</span>
              </label>
              <a href="#" className="text-green-500 hover:text-green-600 text-sm font-medium">
                Forgot password?
              </a>
            </div>
